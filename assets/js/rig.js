/* ═══════════════════════════════════════════════════════════
   rig.js — the fault-recovery simulation.

   The same quadruped the cards show, but here it walks and the
   step you are on is the trial timeline, 0 to 500. One joint
   seizes at the injection point, the gait degrades, and a
...
import { THREE, makeMaterials, makeHalo, buildQuadruped } from './kit.js?v=aa4e9baa';
...
export function initRig(canvas, { reducedMotion = false } = {}) {
  ...
  camera.position.set(2.7, 0.62, 3.1);
